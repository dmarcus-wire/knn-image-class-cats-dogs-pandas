...
from pyimagesearch.preprocessing import SimplePreprocessor # resize to fixed
from pyimagesearch.datasets import SimpleDatasetLoader # loop over images in directory
